...
keepVals = [
  "FIO2", "ctHb", "pH", "pCO2", "pO2", "cHCO3", "ABEc", "sO2", "pCO2(T)c", 
  "pO2(T)c", "Na", "K+", "Cl", "Anion", "Ionized", "cCa++(7.4)c", "Glucose", 
  "Lactate", "Creatinine", "COHb", "MetHb"
]
...
#bug with plamsma protein - if out of range character is there the it give low
#reference value instread of the actual reading
keepVals = [
  "Plasma", "HGB", "HCT", "RBC", "MCV", "RDW", "MCHC", "CHCM", "PLT", "MPV", 
  "Nucleated"
]
...
keepVals = [
  "Other", "Blasts", "Promyelocytes", "Myelocytes", "Metamyelocytes", "Bands", 
...
### TO OD: fix IRON "LIPEMIA", "HEMOLYSIS" (not comming up)


keepVals = [
  "GLU", "BUN", "CREAT", "PHOSPHORUS", "CALCIUM", "MAGNESIUM", "TOTAL", 
  "ALBUMIN", "GLOBULIN", "A/G", "CHOLESTEROL", "CK", "T-BILIRUBIN", "ALP", 
  "ALT", "AST", "GGT", "IRON", "SODIUM", "POTASSIUM", "CHLORIDE", "BICARBONATE", 
  "ANION", "CALCULATED", "LIPEMIA", "HEMOLYSIS"
]
corVals = ["TOTAL", "A/G", "BICARBONATE", "ANION", "CALCULATED"]

def parse_chem(
  inFile = "cbc_chem_test.txt", 
  outFile = 'output_chem.txt', 
  onlyONL = False
):
  printed = []
  with open(outFile, 'w') as outs:
